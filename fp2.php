...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/handlebar-mirror-duke-pulser-ktm.jpg" width="100%" name="image" id="mainImg" alt="Handlebar Mirror">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/handlebar-mirror-duke-pulser-ktm2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/handlebar-mirror-duke-pulser-ktm3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/handlebar-mirror-duke-pulser-ktm4.jpg" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="single-pro-details">
        <h4>KTM ,Pulsar </h4>
        <h6 id="prodname">Handlebar Mirrors</h6>
        <div class="star">
        ...
        <h2 id="prodprice">1,500</h2>
        <br>
            <input type="number" id="productQty" value="1" min="1">
        
        <button class="normal" onclick="addToCart()" id="cart">Add To Cart</a></button>
        <h4>Product Details:</h4>
        <ul><li><span>Mirrors are adjustable to provie a Comtomized viewing angle.</span></li>
            <li><span>Easy to fit Enhances overall look</span></li>
            <li><span> Quick -release mechanisms allow easy removal when not needed</span></li>
            <li><span>Universal Handlebar Rear Viwe Mirror</span></li>
            <li><span>1 pair Mirror</span></li>
       </ul>
