...
<section id="header">
  ...
  <div>
    <ul id="navbar">
      ...
      <li id="scart"><a class="active" href="cart2.php"><i class="fa-solid fa-cart-shopping"></i></a></li>
...
<section id="topbanner" class="section-m1">
    ...
    <button><a href="product2.php" id="low">Explore More</a></button>
</section>
...
<section id="cart" class="section-p1">
               ...
               <!-- <img src="assets/images/facegraphic-helmet.jpg"/>-->
                <div>
                    ...
                    <form method="post" action="remove_item.php" onsubmit="return confirm('Remove this item?');">
                        ...
                        <button type="submit" style="color:#fff;text-decoration: none;font-size: 17px;background-color:hsl(229, 35%, 30%);border-radius: 8px 8px;">Remove</button>
                    </form>
                </div>
            </div>
        </td> 
   ...
   <!--<tr>
    ...
    <div class="checkout-container">
        <a href="checkout.php"><button id="checkout-btn" class="checkout-btn">Checkout</button></a>
    </div>
</section>
<footer class="ft">
    <div class="col">
