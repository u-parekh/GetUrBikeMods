...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/sticker-yamaha.jpg" alt="sticker" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                
            </div>
            <div class="small-img-col">
                <img src="assets/images/sticker-yamaha.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
    ...
    <div class="single-pro-details">
        <h4>YAMAHA R15</h4>
        <h6 id="prodname">Bike Sticker</h6>
        <div class="star">
        ...
        <ul><li><span>Specially Designed for YAMAHA R15 V4 & M Models.  </span></li>
            <li><span>High-Quality Printing: Vibrant, precise graphics that stand out and last.  </span></li>
            <li><span>Waterproof: Fully waterproof, withstands rain and washing.  </span></li>
            <li><span>Easy to Clean: Wipe with a damp cloth; safe for your bike.  </span></li>
            <li><span>Durable Design: Three-part construction ensures durability and easy application.  </span></li>
       </ul>
