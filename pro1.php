...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/face-helmet-re3.jpg" alt="helmet" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
        <div class="small-img-col">
                <img src="assets/images/face-helmet-re3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/face-helmet-re4.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/face-helmet-re3.jpg" width="100%" class="small-img" alt="">
            </div>
    ...
    <div class="single-pro-details">
        <h4>Helmet</h4>
        <h6 id="prodname">Facegraphic-Helmet (Blue-Red-White)</h6>
        <div class="star">
