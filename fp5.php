...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/rear-paddock-stand.jpg" alt="stand" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/rear-paddock-stand2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/rear-paddock-stand3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/rear-paddock-stand-all2.jpg" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="single-pro-details">
        <h4>YAMAHA R15</h4>
        <h6 id="prodname">Rear Paddock Stand</h6>
        <div class="star">
        ...
        <h2 id="prodprice">1,000</h2>
        <br>
            <input type="number" id="productQty" value="1" min="1">
        
        <button class="normal" onclick="addToCart()" id="cart">Add To Cart</a></button>
        <h4>Product Details:</h4>
        <ul><li><span>Universal Compatibility: Designed to fit a wide range of bikes with adjustable swing arm rest clamps, ensuring a secure and snug fit for almost all motorcycle models.  </span></li>
            <li><span>Heavy-Duty Construction: Made from premium-grade metal with a corrosion-resistant powder-coated finish for long-lasting durability and reliability.  </span></li>
            <li><span>Perfect for Maintenance: Ideal for tasks such as chain cleaning, tire changes, lubrication, and other routine bike upkeep.  </span></li>
            <li><span>Quick and Easy Assembly: Dismantle and assemble effortlessly with included tools, allowing convenient storage and portability. </span></li>
            <li><span>Used for double sided swingarm bikes with weight load capacity of 2400kgms. Universal from 26-38cms. Well bushed for vehicle and floor protection.  </span></li>
       </ul>
