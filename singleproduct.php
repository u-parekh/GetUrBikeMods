...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/facegraphic-helmet.jpg" width="100%" name="image" id="mainImg" alt="Helmet">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/facegraphic-helmet2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/facegraphic-helmet3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/facegraphic-helmet4.jpg" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="single-pro-details">
        <h4>Steelbird SBH-17 Terminator ISI Certified Matt Finish Full Face Graphic Helmet </h4>
        <h6 id="prodname">SBH-17 Facegraphic-Helmet(Blue-Black)</h6>
        <div class="star">
        ...
        <ul><li><span>ISI Certified Graphic Helmet</span></li>
            <li><span>High Impact Resistant Thermoplastic shell Breathable Padding with Neck Protector and Extra Comfort for long Drives</span></li>
            <li><span>Italian Design Hygienic Interior with Multi pore for better Ventilation During Hot Weather</span></li>
            <li><span>High Density and low density for more Safety with Air Channels</span></li>
            <li><span>Odourless mouth guard</span></li>
        </ul>
    </div>
</section>
<br>
