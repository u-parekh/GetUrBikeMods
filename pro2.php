...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/handlebar-guard-ktmjpg.jpg" alt="handlebar guard" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/handlebar-guard-ktmjpg.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/handlebar-guard-ktm2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/handlebar-guard-ktmjpg.jpg" width="100%" class="small-img" alt="">
            </div>
    ...
    <div class="single-pro-details">
        <h4>KTM,Pulsar</h4>
        <h6 id="prodname">Handlebar Gaurds</h6>
        <div class="star">
        ...
        <h2 id="prodprice">1,600</h2>
        <br>
            <input type="number" id="productQty" value="1" min="1">
        
        <button class="normal" onclick="addToCart()" id="cart">Add To Cart</a></button>
        <h4>Product Details:</h4>
        <ul><li><span>These handguards developed especially for KTM and Pulsar bikes are an indispensable companion for serious off-road and Supermoto use. </span></li>
            <li><span>The wide, spacious design ensures excellent mobility and maximum protection against impact, flying stones, branches, etc.  </span></li>
            <li><span>Extremely stable aluminum helps prevent broken levers if the bike should ever fall over.  </span></li>
            <li><span>Including fastening materials </span></li>
            <li><span>Note: Cannot be fitted with Twinwall handlebar. </span></li>
       </ul>
