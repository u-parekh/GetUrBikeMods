...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/led-indicator-re.jpg" alt="indicator" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/findicator3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/findicator4.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/findicator5.jpg" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="single-pro-details">
        <h4>Royal Enfield</h4>
        <h6 id="prodname">Four LED Indicator</h6>
        <div class="star">
        ...
        <h2 id="prodprice">2,500</h2>
        <br>
            <input type="number" id="productQty" value="1" min="1">
        
        <button class="normal" onclick="addToCart()" id="cart">Add To Cart</a></button>
        <h4>Product Details:</h4>
        <ul><li><span>Eltron Turbo Motorcycle Amber LED Turn Signal Indicators Light Lamp Regal Raptor 4Pcs 100% Brand New And High Quality Durable Product easy to use Made Of ABS Plastic Product description Easy install, durable Long lasting, low power consumption, energy saving Universal fit all motorcycles </span></li>
            <li><span>Material : ABS Plastic  </span></li>
            <li><span>Body Color : Black  </span></li>
            <li><span>Led Light Color : Yellow  </span></li>
            <li><span>Package Includes : 4xMotorcycle Turn Signal Lights  </span></li>
       </ul>
