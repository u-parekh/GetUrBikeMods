...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/signal-indicator3.jpg" alt="side mirror light" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                
            </div>
            <div class="small-img-col">
                <img src="assets/images/signal-indicator3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
