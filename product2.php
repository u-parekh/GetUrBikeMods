...
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
      ...
      <div class="pro">
        <a href="singleproduct.php"> <!--product desc page-->
          <img src="assets/images/bodycover-ktm.jpg" alt="gloves">
        </a>
        <div class="des">
          <span>Bike Body Cover</span>
          <h5 id="prodname">KTM Bike Cover</h5>
          <div class="star">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="pro">
        <a href="singleproduct.php"> <!--product desc page-->
          <img src="assets/images/rear-paddock-stand3.jpg" alt="indicator">
        </a>
        <div class="des">
      ...
      <div class="pro">
        <a href="singleproduct.html"> <!--product desc page-->
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="product2.php">3</a></li>
    <li class="page-item"><a class="page-link" href="product2.php">Next</a></li>
  </ul>
</nav>
