...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/taillight-harly.jpg" alt="tail light" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                
            </div>
            <div class="small-img-col">
                <img src="assets/images/taillight-harly.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
    ...
    <div class="single-pro-details">
        ...
        <ul><li><span>Easy to install and use  </span></li>
            <li><span> Made from quality and durable materials </span></li>
            <li><span>Enhances safety and convenience while driving  </span></li>
            <li><span>Adds a stylish and personalized touch to your bike</span></li>
            <li><span>Offers practical solutions to common driving problems </span></li>
            <li><span>Tail Light Color : Red  </span></li>
          </ul>
