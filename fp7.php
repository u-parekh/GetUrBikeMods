...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/side-mirror-light2.jpg" alt="side mirror light" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="assets/images/side-mirror-light.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/side-mirror-light3.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
                <img src="assets/images/side-mirror-light2.jpg" width="100%" class="small-img" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="single-pro-details">
        <h4>KTM Duke 390<</h4>
        <h6 id="prodname">Side Mirror With Indicator Lights</h6>
        <div class="star">
        ...
        <ul><li><span>Material: Made of high impact ABS shell and Acrylic glass lens, corrosion resistant,shockproof.  </span></li>
            <li><span>Turn Light: The mirror is highly reflective, and the turn signal is bright and lasting, ensuring that the driver has a clear vision and safe driving!  </span></li>
            <li><span>Safety: Rear View Mirror will provides you a high definition and wider vision, elimination of blind spots has reached safety，has a great degree of usability.  </span></li>
            <li><span>Led Light Color : Yellow  </span></li>
       </ul>
