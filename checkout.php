...
<section id="profile">
<div class="Account">
      <h3 class="font-weight-bold" id="pay">Payment Options</h3>
      <hr class="mx-auto">
</div>
<form id="checkout-opt">
  <table align="center">
    <tr>
        <td></td>
    </tr>
    ...
    <tr>
      <td><a href="paywithcash.php" id="cash-url" class="btn">Pay With Cash</a></td>
    ...
    <tr>
        <td align="center"><span>OR</span></td>
    </tr>
    <tr>
        <td></td>
    </tr>
    ...
    <tr>
       <td><a href="paywithcard.php" id="card-url" class="btn">Pay With Card</a></td>
    </tr>
    </form>
  </table>
</div>
