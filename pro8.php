...
<section id="prodetails" class="sexction-p1">
    <div class="single-pro-image">
        <img src="assets/images/sticker-bike-helmet-all2.jpg" alt="handlebar light" width="100%" name="image" id="mainImg">
        <div class="small-img-group">
            <div class="small-img-col">
                
            </div>
            <div class="small-img-col">
                <img src="assets/images/sticker-bike-helmet-all2.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col">
    ...
    <div class="single-pro-details">
        <h4>Stickers</h4>
        <h6 id="prodname">Bike Stickers</h6>
        <div class="star">
        ...
        <h2 id="prodprice">800</h2>
        <br>
            <input type="number" id="productQty" value="1" min="1">
        
        <button class="normal" onclick="addToCart()" id="cart">Add To Cart</a></button>
        <h4>Product Details:</h4>
        <ul><li><span>High-Quality Printing: Vibrant, precise graphics that stand out and last.  </span></li>
